...
La \kw{bande passante} concerne principalement la vidéo et les données de perception. Les messages MQTT restent légers, tandis que les flux visuels peuvent devenir coûteux. La passerelle vidéo applique des profils de qualité afin d'adapter la résolution et la compression au contexte d'utilisation.  Avec une base de calcul de 1024, afin de conserver une lecture homogène dans toute l'IHM.
